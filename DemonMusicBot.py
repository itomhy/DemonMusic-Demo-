...
def start(client, message):
    ...
    message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
                    InlineKeyboardButton('Rəsmi Kanal ✅', url='https://t.me/itomhyblogs'),
...
def a(client, message):
    ...
    try:
        ...
        for i in range(len(dur_arr)-1, -1, -1):
            ...
            secmul *= 60
        message.reply_audio(audio_file, caption=rep, parse_mode='md',quote=False, title=title, duration=dur, thumb=thumb_name, performer="@itomhyblogs")
        m.delete()
        bot.send_audio(chat_id=Config.PLAYLIST_ID, audio=audio_file, caption=rep, performer="@itomhyblogs", parse_mode='md', title=title, duration=dur, thumb=thumb_name)
    except Exception as e:
